...
int location1, location2, step = 4;
DataFlash dataflash;
#endif
...
,
...
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xF7,0x12,0x70,0xC9,0xBF,0xFF,
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
0xFF,0xFF,0xE7,0x12,0xF0,0xC9,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
...
};
#endif
...
void initFlash()
{
  ...
  step = 4;
  location1 = 0;
  location2 = location1 + calculatePage24bbp + step;

  Serial.println(F("Information:"));
  Serial.print(F("bitmap 24bbp: "));
  Serial.print(WIDTH);
  Serial.print(F("x"));
  Serial.print(HEIGHT);
  Serial.print((","));
  ...
  Serial.print(F(" ,calculatePage24bbp:"));
  Serial.println(calculatePage24bbp);
  Serial.print(F("bitmap 1bbp: "));
  Serial.print(WIDTH);
  Serial.print(F("x"));
  Serial.print(HEIGHT);
  Serial.print(F(","));
  ...
  Serial.print(F(" ,calculatePage1bbp:"));
...
void storageDataToFlash(int page, int location)
{
  dataflash.bufferToPage(0, page + location); //buffer --> page
}
...
0x00,0x00,0x01,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x60,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x00,
0x00,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,
0xFF,0x00
  };*/
...
void converTo1BBp()
{
  ...
  {
    //dataflash.pageRead(i, 0);
    dataflash.pageToBuffer(i + location1, 1);
    dataflash.bufferRead(1, 0);
    for (int k = 0; k < byte_per_page; k++)
    {
      if (counterForByte < calculateSize24bbp)
      {
        _data = dataflash.Stransfer(0xff);
        if (counterForByte > 53) // Ingnore 24 bbp
        {
          dataIn[counterForPC++] = _data;
...
void getFreeRAM()
{
  Serial.println(F(">>>>>>>>>>>>>READ FREE RAM >>>>>>>>>>>>"));
  Serial.print(F("Free RAM: "));
  Serial.println(freeMemory());
  Serial.println(F(">>>>>>>>>>>>>END READ FREE RAM >>>>>>>>>>>>"));
}